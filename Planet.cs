...
public class Planet : MonoBehaviour
{
    ...
    // This functions makes a cube with 6 sides and then forces each point on the cube to be the same distance
    // from the center creating a cube-sphere
    void Initialize()
    {
    ...
    void GenerateMesh()
    {
        // For each side of the cube-sphere we initialize a face if object is not initialized yet
        for (int i = 0; i < 6; i++)
        {
